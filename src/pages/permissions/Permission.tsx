...
export default function Permission() {
  ...
  const [
    ...
    useState<PermissionRequest | null>(
      null
    )
  ...
  /*
   * Sama seperti modul Cuti,
   * akun demo Andi Saputra terhubung dengan EMP-001.
   */
  const employeeId =
    isEmployee
      ? 'EMP-001'
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            {isEmployee
              ...
              : 'Pantau dan kelola pengajuan izin karyawan.'}
          </p>
        </div>
        ...
        <>
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div className="border-b border-slate-200 px-6 py-5">
              ...
              <p className="mt-1 text-sm text-slate-500">
                Riwayat izin yang pernah Anda ajukan.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 border-b border-slate-200 p-5 lg:flex-row">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="Cari nama, NIP, divisi, atau jenis izin..."
